...
format: html
theme: minty
monobackgroundcolor: aquamarine
editor: source
...
#| fig-align: center
#| fig-cap:
#|  - "Effect of suppliment type on length of teeth"
#|  - "Effect of suppliment dose on length of teeth"
...
**Question 12** -- Create a numbered list:

1. Conclusion: Given the p-value of about 0.06063 we fail to reject the null hypothesis at the 5% significance level, meaning that there is not a significant difference in the means between group OJ and group VC.

2. Based on this analysis, we can be 95% confident that the true difference in means is between -0.1710156 and 7.5710156 which supports our previous conclusion. 
